    ...
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 h-full flex items-center">
        <div className="max-w-4xl mx-auto text-center">
          {/* Main Title */}
          <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-foreground mb-2 md:mb-3 animate-fade-up leading-[0.9]">
            SAIYED
          </h1>
          <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-3 md:mb-4 animate-fade-up delay-100 leading-[0.9]">
            <span className="text-gradient">FAIZAN</span>
          </h1>

          {/* Subtitle */}
          <p className="font-heading text-xl sm:text-2xl md:text-3xl text-muted-foreground mb-3 md:mb-4 animate-fade-up delay-200 tracking-wide">
          ...
          <div className="h-10 md:h-12 mb-6 md:mb-8 overflow-hidden">
            <p
              key={currentTagline}
              className="text-base sm:text-lg md:text-xl text-foreground/80 font-body animate-fade-up delay-300"
            >
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up delay-400 mb-4 md:mb-6">
            <Button variant="hero" size="lg" onClick={scrollToPortfolio} className="text-base md:text-lg px-6 md:px-8 py-4 md:py-5">
              <Play size={18} className="mr-2" />
              Watch My Work
            </Button>
            <Button variant="heroOutline" size="lg" onClick={scrollToContact} className="text-base md:text-lg px-6 md:px-8 py-4 md:py-5">
              Let's Create
            </Button>
          </div>
          ...
          <div className="animate-fade-up delay-500">
            <p className="font-display text-sm md:text-base tracking-[0.2em] text-primary uppercase">
              Delhi, India
            </p>
          </div>
        </div>
